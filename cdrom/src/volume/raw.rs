...
impl<'de> Deserializer<'de> {
    pub fn take<'a>(&'a mut self, len: usize) -> Option<&'de [u8]> {
...
pub struct PrimaryDescriptor {
    ...
    pub l_path_table_lba: DualEndian<u16>,
    // TODO: Make this `Option`.
    pub opt_l_path_table_lba: DualEndian<u16>,
    pub m_path_table_lba: DualEndian<u16>,
    // TODO: Make this `Option`.
    pub opt_m_path_table_lba: DualEndian<u16>,
...
pub struct PathTableRecord {
    ...
    pub extent_lba: u32,
    pub parent_num: u16,
    // The directory identifier and padding follow.
}
...
pub struct PartitionDescriptor {
    ...
    pub vol_part_lba: DualEndian<u32>,
